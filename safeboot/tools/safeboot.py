...
env.AddPreAction("upload", safeboot) # pyright: ignore [reportUndefinedVariable]
env.AddPreAction("uploadfs", safeboot) # pyright: ignore [reportUndefinedVariable]
env.AddPreAction("uploadfsota", safeboot) # pyright: ignore [reportUndefinedVariable]
